...
public class PageInfoWrap<T> implements Serializable{
     ...
     * @param list
     */
    public PageInfoWrap(List<T> list) {
        this(list, 8);
    }
	...
	public PageInfoWrap(List<T> list, int navigatePages) {
    ...
    public String toString() {
        ...
        sb.append(", pageSize=").append(rows);
